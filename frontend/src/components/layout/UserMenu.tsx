    ...
    <div ref={rootRef} className="relative">
      ...
      {open ? (
        <div
          role="menu"
          aria-label="Account"
          className="absolute right-0 top-11 z-[60] w-[calc(100vw-16px)] max-w-64 border border-outline bg-surface-container p-2 sm:w-64"
        >
          <p className="break-all px-3 py-2 font-mono text-xs text-on-surface-variant">{email}</p>
          <div className="border-t border-outline-variant">
            ...
            <a href="/settings/preferences" role="menuitem" onClick={() => setOpen(false)} className="block px-3 py-2 text-sm text-on-surface hover:bg-surface-container-high">Preferences</a>
