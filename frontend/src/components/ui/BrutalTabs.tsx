      ...
      <div role="tablist" aria-label="Sections" className="mb-4 flex flex-wrap gap-2" onKeyDown={onKeyDown}>
        {tabs.map((tab) => (
          <button
            ...
            className={cn(
              "border px-4 py-2 font-mono text-[11px] uppercase tracking-widest transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-container min-h-[44px]",
              tab.id === active
